...
ATTR_ROW_BUF		EQU $2104	;SCRATCHPAD AREA FOR UPDATING ATTRIBUTE ROWS
ATTR_ROW_BUF_END	EQU $21A3
...
DIV16_LOOP
	...
	MOVE W, AUX2, R1	;MAKE THE SUBTRACTION RESULT THE NEW DENOMINATOR
